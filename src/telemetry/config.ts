 ...
 * Stores anonymous ID and notice-seen flag in ~/.config/superpowers/config.json
 */
 ...
 * Uses ~/.config/superpowers/config.json on all platforms.
 */
export function getConfigPath(): string {
  const configDir = path.join(os.homedir(), '.config', 'superpowers');
