 ...
 * - Opt-out via SUPERPOWERS_TELEMETRY=0 or DO_NOT_TRACK=1
...
const POSTHOG_HOST = 'https://edge.superpowers.dev';
 ...
 *
 * Disabled when:
 * - SUPERPOWERS_TELEMETRY=0
 * - DO_NOT_TRACK=1
 * - CI=true (any CI environment)
 */
export function isTelemetryEnabled(): boolean {
  // Check explicit opt-out
  if (process.env.SUPERPOWERS_TELEMETRY === '0') {
    return false;
  }
 ...
 * @param version - The Superpowers version
 */
