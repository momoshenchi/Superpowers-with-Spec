...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'superpowers';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'superpowers';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/superpowers/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/superpowers/
 * - Windows fallback: %APPDATA%/superpowers/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/superpowers/ if XDG_DATA_HOME is set
