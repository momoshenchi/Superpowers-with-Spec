...
export function getSkillTemplates(workflowFilter?: readonly string[]): SkillTemplateEntry[] {
  const all: SkillTemplateEntry[] = [
    ...
    { template: getSimplifySkillTemplate(), dirName: 'superpowers-simplify', workflowId: 'simplify' },
    { template: getDesignVerifySkillTemplate(), dirName: 'superpowers-design-verify', workflowId: 'design-verify' },
    { template: getShapeReviewSkillTemplate(), dirName: 'superpowers-shape-review', workflowId: 'shape-review' },
...
export function getCommandTemplates(workflowFilter?: readonly string[]): CommandTemplateEntry[] {
  const all: CommandTemplateEntry[] = [
    ...
    { template: getSpSimplifyCommandTemplate(), id: 'simplify' },
    { template: getSpDesignVerifyCommandTemplate(), id: 'design-verify' },
    { template: getSpShapeReviewCommandTemplate(), id: 'shape-review' },
