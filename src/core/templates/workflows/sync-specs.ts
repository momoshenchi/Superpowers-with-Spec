...
function buildSyncInstructions(projection: Projection): string {
  return `Sync delta specs from a change to main specs.

This is an **agent-driven** operation - you will read delta specs and directly edit main specs to apply the changes. This allows intelligent merging (e.g., adding a scenario without copying the entire requirement).

${getChangeTargetingInput('sync', projection)}

**Steps**

${getChangeTargetingStep('sync')}
...
export function getSyncSpecsSkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: buildSyncInstructions('skill'),
    license: 'MIT',
...
export function getSpSyncCommandTemplate(): CommandTemplate {
  return {
    ...
    category: 'Workflow',
    tags: ['workflow', 'specs'],
    content: buildSyncInstructions('command'),
  };
}
