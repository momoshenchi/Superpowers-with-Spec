 ...
 *
 * @param projectRoot - The root directory of the project (where `superpowers/` lives)
...
export function readProjectConfig(projectRoot: string): ProjectConfig | null {
  ...
  try {
    ...
    if (!raw || typeof raw !== 'object') {
      console.warn(`superpowers/config.yaml is not a valid YAML object`);
      return null;
    }
    ...
    console.warn(`Failed to parse superpowers/config.yaml:`, error);
    return null;
  }
}
