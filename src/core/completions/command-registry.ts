...
/**
 * Registry of all Superpowers CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env SUPERPOWERS_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'change',
    description: 'Manage Superpowers change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage Superpowers specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
