...
**Input**: Optionally specify a change name after `/sp:archive` (e.g., `/sp:archive add-auth`). Use an explicit name when given; otherwise resolve with the targeting rule in Step 1.
