...
description: Use when the user explicitly asks for a security review, vulnerability scan, or audit of injection, secrets, access control, or similar security issues. Do not trigger on generic bug-finding.
---
