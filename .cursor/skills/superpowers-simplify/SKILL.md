---
name: superpowers-simplify
description: Perform behavior-preserving cleanup for a Superpowers change.
license: MIT
...
`/sp:simplify → 4 cleanup agents in parallel → apply the fixes`
