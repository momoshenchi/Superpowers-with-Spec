...
describe('command-generation/adapters', () => {
  ...
  it('uses namespaced paths for simplify, design-verify, and shape-review across representative adapters', () => {
    const adapters = [claudeAdapter, codexAdapter, opencodeAdapter, cursorAdapter, geminiAdapter];

    for (const adapter of adapters) {
      for (const commandId of ['simplify', 'design-verify', 'shape-review']) {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'sp', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'sp', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'sp', 'bulk-archive.md'));
    });
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with sp- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'sp-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'sp-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'sp-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: /sp-explore');
      expect(output).toContain('id: sp-explore');
      expect(output).toContain('category: Workflow');
      expect(output).toContain('description: Enter explore mode for thinking');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('windsurfAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.windsurf', 'workflows', 'sp-explore.md'));
    });
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'sp-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'sp-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'sp-explore.md'));
    });
  ...
  describe('codexAdapter', () => {
    ...
    it('should generate path ending with correct structure', () => {
      const filePath = codexAdapter.getFilePath('explore');
      expect(filePath).toMatch(/prompts[/\\]sp-explore\.md$/);
    });
    ...
    it('should default to homedir/.codex', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        const expected = path.join(os.homedir(), '.codex', 'prompts', 'sp-explore.md');
    ...
    it('should respect CODEX_HOME env var', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        expect(filePath).toBe(path.join(path.resolve('/custom/codex-home'), 'prompts', 'sp-explore.md'));
      } finally {
        if (original !== undefined) {
          process.env.CODEX_HOME = original;
        } else {
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested sp folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'sp', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'sp-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'superpowers', 'commands', 'sp-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested sp folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'sp', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'sp-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'sp', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'sp-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'sp-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'sp-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'sp-explore.md'));
    });
    ...
    it('should transform colon-based command references to hyphen-based', () => {
      const contentWithCommands: CommandContent = {
        ...sampleContent,
        body: 'Use /sp:new to start, then /sp:apply to implement.',
      };
      const output = opencodeAdapter.formatFile(contentWithCommands);
      expect(output).toContain('/sp-new');
      expect(output).toContain('/sp-apply');
      expect(output).not.toContain('/sp:new');
      expect(output).not.toContain('/sp:apply');
    });

    it('should handle multiple command references in body', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/sp:explore for ideas
/sp:new to create
/sp:continue to proceed
/sp:apply to implement`,
      };
      const output = opencodeAdapter.formatFile(contentWithMultipleCommands);
      expect(output).toContain('/sp-explore');
      expect(output).toContain('/sp-new');
      expect(output).toContain('/sp-continue');
      expect(output).toContain('/sp-apply');
    });
  });
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested sp folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'sp', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'sp-explore.toml'));
    });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'sp-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'sp-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'sp-bulk-archive.md'));
    });
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'sp-explore.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'sp', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'sp-test.md']);
    });

    it('Windsurf adapter uses path.join for paths', () => {
      const filePath = windsurfAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.windsurf', 'workflows', 'sp-test.md']);
    });
