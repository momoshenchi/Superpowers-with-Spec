  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize Superpowers',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('# Fish completion script for Superpowers CLI');
      expect(script).toContain('function __fish_superpowers');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_superpowers_using_subcommand');
      expect(script).toContain('function __fish_superpowers_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c superpowers");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize Superpowers'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_superpowers_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_superpowers_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_superpowers_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_superpowers_items');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_superpowers_changes');
      expect(script).toContain('superpowers __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_superpowers_specs');
      expect(script).toContain('superpowers __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_superpowers_items');
      expect(script).toContain('__fish_superpowers_changes');
      expect(script).toContain('__fish_superpowers_specs');
    });
