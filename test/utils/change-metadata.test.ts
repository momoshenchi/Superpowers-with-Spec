...
describe('writeChangeMetadata', () => {
  ...
  beforeEach(async () => {
    ...
    changeDir = path.join(testDir, 'superpowers', 'changes', 'test-change');
  ...
  it('should write valid YAML metadata file', async () => {
    ...
    const metaPath = path.join(changeDir, '.superpowers.yaml');
...
describe('resolveSchemaForChange', () => {
  ...
  it('should use project config schema when no metadata exists', async () => {
    ...
    const configDir = path.join(testDir, 'superpowers');
