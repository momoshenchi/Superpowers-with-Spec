...
describe('interactive utilities', () => {
  let originalSuperpowersInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalSuperpowersInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalSuperpowersInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalSuperpowersInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
