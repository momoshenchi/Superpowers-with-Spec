...
describe('telemetry/config', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = path.join(os.tmpdir(), `superpowers-telemetry-test-${Date.now()}`);
  ...
  describe('getConfigPath', () => {
    it('should return path to config.json in .config/superpowers', () => {
      const result = getConfigPath();
      expect(result).toBe(path.join(tempDir, '.config', 'superpowers', 'config.json'));
    });
  });
  ...
  describe('readConfig', () => {
    ...
    it('should load valid config from file', async () => {
      const configDir = path.join(tempDir, '.config', 'superpowers');
  ...
  describe('writeConfig', () => {
    ...
    it('should write config to file', async () => {
      const configPath = path.join(tempDir, '.config', 'superpowers', 'config.json');
