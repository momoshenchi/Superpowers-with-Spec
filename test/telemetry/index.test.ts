...
describe('telemetry/index', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = path.join(os.tmpdir(), `superpowers-telemetry-test-${randomUUID()}`);
  ...
  describe('isTelemetryEnabled', () => {
    it('should return false when SUPERPOWERS_TELEMETRY=0', () => {
      process.env.SUPERPOWERS_TELEMETRY = '0';
    ...
    it('should return true when no opt-out is set', () => {
      delete process.env.SUPERPOWERS_TELEMETRY;
      delete process.env.DO_NOT_TRACK;
      delete process.env.CI;
      expect(isTelemetryEnabled()).toBe(true);
    });

    it('should prioritize SUPERPOWERS_TELEMETRY=0 over other settings', () => {
      process.env.SUPERPOWERS_TELEMETRY = '0';
      delete process.env.DO_NOT_TRACK;
      delete process.env.CI;
      expect(isTelemetryEnabled()).toBe(false);
