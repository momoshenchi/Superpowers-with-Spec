...
Define the install scope model for Superpowers-generated skills and commands, including scope preference, effective scope resolution, and fallback/error semantics.
...
- **AND** SHALL automatically remove only Superpowers-managed files in the previous effective scope
