...
- [ ] 1.4 Extend `superpowers config list` output to show install scope and source (`explicit`, `new-default`, `legacy-default`)
...
- [ ] 4.1 Add scope override flag to `superpowers init` (`--scope global|project`)
...
- [ ] 5.1 Add scope override flag to `superpowers update` (`--scope global|project`)
...
- [ ] 6.1 Extend `superpowers config profile` interactive flow to select install scope
