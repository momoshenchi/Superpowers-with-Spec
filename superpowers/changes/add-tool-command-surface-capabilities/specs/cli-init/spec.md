...
- **WHEN** user runs `superpowers init` with a selected tool that has a command adapter
...
- **WHEN** user runs `superpowers init` with a selected tool whose command surface is `skills-invocable`
- **AND** delivery is set to `both`
...
- **WHEN** user runs `superpowers init` with a selected tool whose command surface is `none`
- **AND** delivery is set to `both`
...
- **WHEN** user runs `superpowers init` with multiple tools
...
- **WHEN** user runs `superpowers init` with a selected tool that has no command surface capability
- **AND** delivery is set to `commands`
