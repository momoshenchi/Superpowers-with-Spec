...
- **AND** distinguishes the proposal review of artifact completeness and implementability from the post-implementation integration review of cross-dispatch-unit behavior, the integrated diff, and full validation
...
- **AND** it SHALL explain that the complete report is shown before affected planning artifacts are repaired
- **AND** it SHALL explain that only unresolved BLOCKER findings require re-review before readiness
