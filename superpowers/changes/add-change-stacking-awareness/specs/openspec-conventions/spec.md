...
Superpowers conventions SHALL define optional metadata fields for sequencing and decomposition across concurrent changes.
...
- **WHEN** both stack metadata and `superpowers/changes/IMPLEMENTATION_ORDER.md` are present
