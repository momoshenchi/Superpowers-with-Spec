...
## Problem
The agent instructions live in `superpowers/README.md`, which clashes with conventional project README usage and creates confusion for tooling and contributors.

## Solution
Rename the agent instruction file to `superpowers/AGENTS.md` and update Superpowers tooling to use the new filename:
- `superpowers init` generates `AGENTS.md` instead of `README.md`
...
## Success Metrics
- `superpowers init` creates `superpowers/AGENTS.md`
- `superpowers update` refreshes `AGENTS.md`
- All specs reference `superpowers/AGENTS.md`
