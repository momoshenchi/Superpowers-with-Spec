...
- [x] Rename `superpowers/README.md` to `superpowers/AGENTS.md`
...
- [x] Modify `superpowers init` to generate `AGENTS.md`
- [x] Update `superpowers update` to refresh `AGENTS.md`
- [x] Ensure CLAUDE.md markers link to `@superpowers/AGENTS.md`

## 4. Update Specifications
- [x] Modify `cli-init` spec to reference `AGENTS.md`
- [x] Modify `cli-update` spec to reference `AGENTS.md`
- [x] Modify `superpowers-conventions` spec to include `AGENTS.md` in project structure
