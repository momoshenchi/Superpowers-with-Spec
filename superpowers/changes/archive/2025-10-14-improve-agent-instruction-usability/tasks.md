...
- [x] 1.1 Draft a quick-reference section that surfaces file templates and formatting rules at the top of `superpowers/AGENTS.md`.
...
- [x] 2.2 Insert a pre-validation checklist capturing common lint failures before running `superpowers validate`.
