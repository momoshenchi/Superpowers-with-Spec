...
- **NEW**: `superpowers status --change <id>` shows artifact completion state
- **NEW**: `superpowers next --change <id>` shows artifacts ready to create
- **NEW**: `superpowers instructions <artifact> --change <id>` outputs enriched template
- **NEW**: `superpowers templates [--schema <name>]` shows resolved template paths
- **NEW**: `superpowers new change <name>` creates a new change directory
