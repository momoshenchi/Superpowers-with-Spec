...
- [x] 1.1 Update superpowers/README.md section on "Creating a Change Proposal"
...
- [x] 3.2 Update docs/superpowers-walkthrough.md
  - [x] Replace diff examples with future state examples
  - [x] Ensure the walkthrough reflects new approach

## 4. Create New Spec
- [x] 4.1 Finalize superpowers-conventions spec in main specs/ directory
