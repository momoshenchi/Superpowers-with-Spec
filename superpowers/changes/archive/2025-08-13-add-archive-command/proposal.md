## Why
Need a command to archive completed changes to the archive folder with proper date prefixing, following Superpowers conventions. Currently changes must be manually moved and renamed.
...
- Update main specs from the change's future state specs (copy from `changes/[name]/specs/` to `superpowers/specs/`)
