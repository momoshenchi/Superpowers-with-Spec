...
- Create `sp-verify-skill` capability spec
...
- Affected specs: New `sp-verify-skill` spec
- Affected code:
...
- Generated artifacts: When users run `superpowers artifact-experimental-setup`:
  - Creates `.claude/skills/superpowers-verify-change/SKILL.md`
  - Creates `.claude/commands/sp/verify.md`
- Related skills: Works alongside `/sp:apply` and before `/sp:archive`
