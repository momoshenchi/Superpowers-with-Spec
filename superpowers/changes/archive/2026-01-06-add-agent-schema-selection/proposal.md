...
- Update `superpowers-new-change` skill to prompt user for schema selection
- Update `superpowers-continue-change` skill to work with any schema's artifacts
- Update `superpowers-apply-change` skill to handle schema-specific task structures
