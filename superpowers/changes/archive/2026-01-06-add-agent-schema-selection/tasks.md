...
- [x] 1.2 Ensure `superpowers templates --schema <name>` returns artifact list for any schema
...
- [x] 2.3 Pass selected schema to `superpowers new change --schema <name>`
...
- [x] 3.2 Read artifact list dynamically from `superpowers status --json`
