...
Superpowers needs a standard location for user-level configuration that works across platforms and follows established conventions. This will serve as the foundation for settings, feature flags, and future artifacts like workflows or templates.
...
```
Unix/macOS: $XDG_CONFIG_HOME/superpowers/ or ~/.config/superpowers/
Windows:    %APPDATA%/superpowers/
```
...
- `~/.superpowers/` - Simple but clutters home directory
