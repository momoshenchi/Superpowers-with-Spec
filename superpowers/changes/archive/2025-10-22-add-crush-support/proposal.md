## Why
Add support for Crush AI assistant in Superpowers to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/superpowers/ (proposal.md, apply.md, archive.md)