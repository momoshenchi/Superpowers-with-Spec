...
- [x] Verify bash completions work manually: `superpowers completion install bash && exec bash`
...
- [x] Verify fish completions work manually: `superpowers completion install fish`
...
- [x] Run `superpowers validate extend-shell-completions --strict` and resolve all issues
- [x] Update error messages to list all four supported shells
- [x] Verify `superpowers completion --help` documentation is current
