...
## Why
The Superpowers project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up Superpowers file structures and keep AI instructions updated.
