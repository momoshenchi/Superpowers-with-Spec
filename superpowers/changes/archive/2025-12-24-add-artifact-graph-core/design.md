...
This module will coexist with the current Superpowers system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing Superpowers functionality
...
**Resolution order:**
1. `${XDG_DATA_HOME:-~/.local/share}/superpowers/schemas/<name>.yaml` - Global user override
...
- Unix/macOS fallback: `~/.local/share/superpowers/`
- Windows fallback: `%LOCALAPPDATA%/superpowers/`
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/superpowers/schemas/<name>.yaml`
