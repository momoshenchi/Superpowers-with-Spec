...
Superpowers specifications lack a consistent structure that makes sections visually identifiable and programmatically parseable across different specs. This makes it harder to maintain consistency and build tooling.
...
- Affected specs: superpowers-conventions (enhancement to existing capability)
