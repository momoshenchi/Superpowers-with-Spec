...
`superpowers init` SHALL treat extend mode with no selected tools as a guarded error.

#### Scenario: Preventing empty extend runs
- **WHEN** Superpowers is already initialized and the user selects no additional tools
