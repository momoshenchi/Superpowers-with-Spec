...
## 1. Extend Init Guard
- [x] 1.1 Detect existing Superpowers structures at the start of `superpowers init` and enter an extend mode instead of failing.
...
## 4. Verification
- [x] 4.1 Add tests covering rerunning `superpowers init` to add another tool and the scenario where the user declines to add anything.
