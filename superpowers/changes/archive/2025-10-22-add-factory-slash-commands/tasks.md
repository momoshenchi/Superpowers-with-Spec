...
- [x] 2.1 Create shared templates for Factory's `superpowers-proposal`, `superpowers-apply`, and `superpowers-archive` custom commands following Factory's CLI format.
- [x] 2.2 Wire the templates into init/update so generation happens on create and refresh respects Superpowers markers.
