...
- [x] 3.1 Add onboard skill to `getSkillTemplates()` array in `src/core/shared/skill-generation.ts` with dirName `superpowers-onboard`
...
- [x] 4.2 Test skill generation by running `superpowers init` in a test directory and verifying onboard skill/command files are created
