...
- [x] 3.3 Run `superpowers init --tools opencode` in a temp directory and verify:
  - Command files in `.opencode/command/` contain `/sp-` references (not `/sp:`)
  - Skill files in `.opencode/skills/` contain `/sp-` references (not `/sp:`)
