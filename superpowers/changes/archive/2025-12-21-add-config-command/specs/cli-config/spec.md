...
Provide a CLI interface for viewing and modifying global Superpowers configuration. Enables users to manage settings without manually editing JSON files, with support for scripting and automation.
