...
- [x] 1.3 Ensure `updateExisting` rewrites the archive frontmatter/body so `$ARGUMENTS` persists after `superpowers update`
...
- [x] 2.3 Add step to validate the change ID exists using `superpowers list` before archiving

## 3. Update Documentation
- [x] 3.1 Update AGENTS.md archive examples to show argument usage
- [x] 3.2 Document that OpenCode now supports `/superpowers:archive <change-id>`
