...
- **`superpowers list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (superpowers change show)
...
- Use `superpowers list --specs` to discover current capabilities
