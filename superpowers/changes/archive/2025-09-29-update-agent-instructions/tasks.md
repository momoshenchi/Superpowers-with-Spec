...
## 1. Restructure Superpowers README.md
...
- [x] 3.1 Document `superpowers list` and `superpowers list --specs` commands
- [x] 3.2 Document `superpowers show` with all flags and interactive mode
- [x] 3.3 Document `superpowers diff [change]` for viewing spec differences
- [x] 3.4 Document `superpowers archive` with --skip-specs option
- [x] 3.5 Document `superpowers validate` with --strict and batch modes
- [x] 3.6 Document `superpowers init` and `superpowers update` commands
...
- [x] 8.2 Run `superpowers init` to verify CLAUDE.md generation
