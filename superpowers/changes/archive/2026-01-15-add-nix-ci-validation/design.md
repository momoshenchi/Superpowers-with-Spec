...
Superpowers recently added Nix flake support to enable Nix users to install the tool. This includes:
...
- Running Superpowers's full test suite through Nix build - existing CI already does this
...
- **Q**: Should we run full Superpowers tests through the Nix build?
