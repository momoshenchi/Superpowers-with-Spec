...
Instructions for AI coding assistants using Superpowers for spec-driven development.

## TL;DR Quick Checklist
- Search existing work: `superpowers spec list --long`, `superpowers list`
...
- Validate with `superpowers validate [change-id] --strict`
...
- **AND** summarize which assistant files were created versus refreshed (e.g., `CLAUDE.md (created)`, `.cursor/commands/superpowers-apply.md (refreshed)`)
