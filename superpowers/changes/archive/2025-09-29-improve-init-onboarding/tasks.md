...
- [x] 1.2 Update `superpowers/specs/cli-init/spec.md` to capture multi-select onboarding requirements

## 2. Implementation
- [x] 2.1 Add multi-select support to the `superpowers init` prompt, including indicators for existing tool configs
...
- [x] 3.2 Perform `superpowers init` smoke test in a temp directory (document output)
