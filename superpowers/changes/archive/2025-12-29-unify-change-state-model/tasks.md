...
- [x] Add test for `superpowers status --change <scaffolded-change>`
- [x] Add test for `superpowers next --change <scaffolded-change>`
- [x] Add test for `superpowers instructions proposal --change <scaffolded-change>`
...
- [x] Manual test: `superpowers new change foo && superpowers status --change foo`
- [x] Manual test: `superpowers new change foo && superpowers view` shows foo in Draft
- [x] Validate with `superpowers validate unify-change-state-model --strict`
