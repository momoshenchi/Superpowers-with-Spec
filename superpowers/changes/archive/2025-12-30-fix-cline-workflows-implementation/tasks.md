...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/superpowers-*.md` to `.clinerules/workflows/superpowers-*.md`
...
- [x] Verify the change follows Superpowers conventions
