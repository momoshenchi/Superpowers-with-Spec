...
- **BREAKING**: Existing Cline users will need to re-run `superpowers init` to get the corrected workflow files
...
- Modified files: `.clinerules/workflows/superpowers-*.md` (moved from `.clinerules/superpowers-*.md`)
