...
The `superpowers view` command provides a comprehensive dashboard view of the Superpowers project state, displaying specifications, changes, and progress metrics in a unified, visually appealing format to help developers quickly understand project status.
## Requirements
...
- **WHEN** user runs `superpowers view`
- **THEN** system displays a formatted dashboard with sections for summary, active changes, completed changes, and specifications

#### Scenario: No Superpowers directory

- **WHEN** user runs `superpowers view` in a directory without Superpowers
- **THEN** system displays error message "✗ No superpowers directory found"
