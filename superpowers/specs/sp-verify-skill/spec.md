# sp-verify-skill Specification

## Purpose
Define `/sp:verify` behavior for assessing implementation completeness, correctness, and coherence against change artifacts.
...
- **WHEN** verifying completeness
- **AND** delta specs exist in `superpowers/changes/<name>/specs/`
