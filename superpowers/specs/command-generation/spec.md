...
## Purpose
Define tool-agnostic command content and adapter contracts for generating tool-specific Superpowers command files.
...
- **THEN** `CommandContent` SHALL include:
  ...
  - `name`: human-readable name (e.g., 'Superpowers Explore')
  - `description`: brief description of command purpose
  - `category`: grouping category (e.g., 'Superpowers')
...
- **WHEN** generating all sp commands for a tool
