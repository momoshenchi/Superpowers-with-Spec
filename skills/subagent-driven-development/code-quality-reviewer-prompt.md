...
Use this template when dispatching the single formal reviewer after all work packages are integrated.
...
**Only dispatch after all work packages are integrated and their local verification has passed.**

```
Task tool (superpowers:code-reviewer):
  Use template at requesting-code-review/code-reviewer.md

  WHAT_WAS_IMPLEMENTED: [summaries from every integrated work package]
