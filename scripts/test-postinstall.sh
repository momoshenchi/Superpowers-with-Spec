...
echo "======================================"
echo "Testing Superpowers Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_SUPERPOWERS_NO_COMPLETIONS="${SUPERPOWERS_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should attempt to install completions)"
echo "--------------------------------------"
unset CI
unset SUPERPOWERS_NO_COMPLETIONS
...
echo "Test 3: SUPERPOWERS_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export SUPERPOWERS_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_SUPERPOWERS_NO_COMPLETIONS" ]; then
  export SUPERPOWERS_NO_COMPLETIONS="$ORIGINAL_SUPERPOWERS_NO_COMPLETIONS"
else
  unset SUPERPOWERS_NO_COMPLETIONS
fi
